...
class Version20190418081223 extends AbstractPimcoreMigration
{
    ...
    public function up(Schema $schema)
    {
        ...
        $processesTable->addColumn("running", "boolean", ['default' => true, 'notnull' => false]);
        $processesTable->addColumn("hash", "string", ['default' => '', 'notnull' => false]);
    }
    ...
    public function down(Schema $schema)
    {
        ...
        $processesTable->dropColumn("running");
        $processesTable->dropColumn("hash");
    }
}
